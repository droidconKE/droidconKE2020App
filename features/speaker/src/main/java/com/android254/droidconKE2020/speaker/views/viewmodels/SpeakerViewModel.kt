...
class SpeakerViewModel : ViewModel() {
    ...
    fun fetchSpeakerDetails() {
        val speakerDetailsModel = SpeakerDetailsModel(
            ...
            "Been in the tech industry for over 20 years. Am passionate about developer communities, motivating people and building successful organizations. Proven track record in product development, business development,\n" +
                    "    and nurturing mission critical strategic partner relationships. Have lived and worked in Germany for 10 years. Fluent in German and English",
