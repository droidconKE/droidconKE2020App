...
data class SessionItem(
   ...
   @Expose @SerializedName("session_image") val sessionImage: Any,
...
data class Speaker(
    ...
    @Expose @SerializedName("facebook") val facebook: Any,
    @Expose @SerializedName("instagram") val instagram: Any,
    @Expose @SerializedName("linkedin") val linkedin: Any,
